...
function StatsCard(props: StatsCardProps) {
  ...
  return (
    <Stat
      ...
      rounded={'lg'}>
      <StatLabel fontWeight={'medium'} fontSize={'3xl'}>
        {title}
      </StatLabel>
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacingX={10} spacingY={20}>
            ...
            <Box maxW="8xl" pt={5} px={{ base: 12, sm: 12, md: 8, lg: 1 }}>
              <SimpleGrid columns={{ base: 1, md: 1 }} spacing={{ base: 5, lg: 8 }} textAlign={'center'}>
                <StatsCard title={'15%'} stat={'Meningkatkan kemampuan membaca anak'} />
                <StatsCard title={'50%'} stat={'Anak mendapatkan cerita yang inspriratif'} />
              </SimpleGrid>
            </Box>
          </SimpleGrid>
        </Container>
